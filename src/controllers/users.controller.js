...
let ACCESS_JWT_SECRET="cjsallllmcwenwjvooqdnnnnfnfnfnsfwef"

let REFRESH_JWT_SECRET= "skjnmdfnvhjiooooerjbvkpackwpcwpoe"

const generateAccessToken = (user) => {
  return jwt.sign({ email: user.email }, ACCESS_JWT_SECRET, {
    expiresIn: "6h",
  });
};
const generateRefreshToken = (user) => {
  return jwt.sign({ email: user.email }, REFRESH_JWT_SECRET, {
    expiresIn: "7d",
  });
};
